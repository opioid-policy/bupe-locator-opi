    ...
    <div className={styles.aboutContainer}>
      <div className={styles.content}>
        ...
        <section id="what-we-collect">
          ...
          <p>
            A lot of websites collect personal information to sell you ads or other products. Some times this is pretty sneaky and happening without you knowing or saying it is ok. That is bad for your privacy. <strong>We designed our website to not do that.</strong>
          </p>
          <p>
            When it comes to information like who you are, if you had an addiction, what medicine you take, or where you live, people and companies can use that to discriminate against you. So, we do not give that information or any other information about you to other companies.
          </p>
          ...
          <br/>
          <p> Our most important promise is to protect your privacy. We have designed this site to collect <strong>zero</strong> personal information about you. The submission form is just enough information to be useful to other people and not identify you. </p>
          <h4 style={{ marginTop: '2rem' }}>When you submit to our pharmacy bupe updater:</h4>
          <ul>
            <li>We <strong>do not</strong> know your name.</li>
            <li>We <strong>do not</strong> know your email or phone number.</li>
            <li>We <strong>do not</strong> know your computer&apos;s IP address.</li>
            <li>We <strong>do not</strong> track your location.</li>
          </ul>
          <br />
          <p>
          ...
          <p>
            There are some places where we collect personal information <strong>but you do not need to use these parts of the website to report or locate bupe.</strong>
          </p>
          <ul>
        ...
        <section id="how-technology-works">
          ...
          <ul>
            ...
            <Link href="https://organicmaps.app/" className={styles.styledLink} target="_blank" rel="noopener noreferrer">
             Organic Maps
            </Link> on your phone to reduce these issues. You can also use Google Maps in &quot;Incognito Mode&quot; but other Google &quot;Incognito Mode&quot; products were found to not actually protect your privacy, so it is best to avoid products from companies like Google, Meta/Facebook/Instagram, Amazon, Apple, Microsoft, etc to avoid them getting your information to use for advertising. </li>
            <br/>
