...
export default function MethadoneNaltrexonePage() {
  return (
    ...
    <div className={styles.aboutContainer}>
      <div className={styles.content}>
        <h2><T>A note on methadone and naltrexone...or, why are they not included here?</T></h2>
        
        <p>
         <T>You may notice that other medications for Opioid Use Disorder (OUD) -  methadone and naltrexone - are not included in our search tool. This is intentional and reflects the project&apos;s specific focus on pharmacy-based access to buprenorphine.</T>
        </p>
 ...
 <hr style={{ margin: '3rem 0', border: 'none', borderTop: '1px solid var(--border-color)' }} />
        ...
        <p>
         <T>Restricting methadone access is a policy choice, not a medical necessity. Many other countries have safely integrated methadone dispensing into community pharmacies, including the United Kingdom, Canada, and Australia. In these places, a patient can pick up their medication from their local pharmacist, just like any other prescription. While we advocate for reduce methadone restrctions, this project is focused on improving access to buprenorphine through pharmacies.</T>
        </p>
        
 <hr style={{ margin: '3rem 0', border: 'none', borderTop: '1px solid var(--border-color)' }} />

        {/* --- Naltrexone Section --- */}
        <h3><T>More about Naltrexone</T></h3>

        <p>
         <T>Naltrexone for OUD is most commonly prescribed as a long-acting injection. While this medication is often ordered through pharmacies, it is almost always administered in a medical setting, not dispensed directly to the patient at a pharmacy counter. The tablet form of naltrexone, while available at pharmacies, is less commonly used for OUD.</T>
        </p>
        <p>
        ...
        <h4 style={{ marginBottom: '1rem', fontWeight: 'bold' }}> 
          Find Methadone and Naltrexone Treatment
        </h4>
        <p>
